...
**Added Metrics - Two additional metrics were created using performance in the events; the All Skill Score and the Plyo / Speed Score. The All Skill Score measures performance across all categories. It was created by scaling all results to a number between 0 and 1, where 0 was the worst performance and 1 was the top performance in the event. The scores were added together to get the All Skill Score. The Plyo / Speed Score is the same, except that the Bench Press is taken out.

Top Performers:
Jerick McKinnon from Southern Georgia emerged as the most well-rounded player when considering performance across all events. His consistent performance across multiple metrics distinguished him as a standout athlete.

Plyo/Speed Score:
Byron Jones achieved the highest Plyo/Speed Score, which excludes the bench press. This metric highlights his exceptional performance in the specified categories, emphasizing his athleticism and explosiveness.
